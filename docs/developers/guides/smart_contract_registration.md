...
argusd tx feesplit register $CONTRACT $NONCE $WITHDRAWER \
...
```bash
# Check feesplits
argusd q feesplit contract $CONTRACT
```
...
argusd tx feesplit update $CONTRACT $WITHDRAWER \
...
argusd tx feesplit cancel $CONTRACT \
--gas=700000 --gas-prices=10000aevmos \
--from=mm
```
