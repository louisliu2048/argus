...
```bash
$ argusd keys add mykey-restored --recover
...
```bash
argusd keys unsafe-export-eth-key mykey > mykey.export
...
```bash
$ argusd keys import mykey-imported ./mykey.export
Enter passphrase to decrypt your key:
```
...
```
$ argusd keys unsafe-import-eth-key mykey-imported ./mykey.export
