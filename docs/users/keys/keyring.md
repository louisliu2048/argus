...
MY_VALIDATOR_ADDRESS=$(argusd keys show mykey -a)
```
...
yes $KEYPASSWD | argusd keys add me
yes $KEYPASSWD | argusd keys show me
# start argusd with keyring-backend flag
argusd --keyring-backend=file start
```
