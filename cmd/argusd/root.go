...
import (
	...
	"github.com/louisliu2048/argus/app"
	cmdcfg "github.com/louisliu2048/argus/cmd/config"
	arguskr "github.com/louisliu2048/argus/crypto/keyring"
)
...
func NewRootCmd() (*cobra.Command, params.EncodingConfig) {
	...
	initClientCtx := client.Context{}.
		...
		WithKeyringOptions(arguskr.Option()).
		WithViper(EnvPrefix)
...
func (a appCreator) appExport(
	...
	if height != -1 {
		argusApp = app.NewArgus(logger, db, traceStore, false, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)

		if err := argusApp.LoadHeight(height); err != nil {
			return servertypes.ExportedApp{}, err
		}
	} else {
		argusApp = app.NewArgus(logger, db, traceStore, true, map[int64]bool{}, "", uint(1), a.encCfg, appOpts)
	}

	return argusApp.ExportAppStateAndValidators(forZeroHeight, jailAllowedAddrs)
}
