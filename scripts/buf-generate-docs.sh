...
# also make sure that you are added to the Argus organization on buf
...
buf mod update $ARGUSPROTO

# then, push the argus proto module and documentation
buf push $ARGUSPROTO

# two commit addresses should be printed to the command line
# the argus documentation will have links to the third party documentation
